...
String blogGizlilikPolitikasiDuzMetin = """
Gizlilik Politikası
Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}

Güvenliğiniz bizim için önemli. Bu sebeple bizimle paylaşacağınız kişisel verileriz hassasiyetle korunmaktadır.

Biz, şirketadı, veri sorumlusu olarak, bu gizlilik ve kişisel verilerin korunması politikası ile, hangi kişisel verilerinizin hangi amaçla işleneceği, işlenen verilerin kimlerle ve neden paylaşılabileceği, veri işleme yöntemimiz ve hukuki sebeplerimiz ile; işlenen verilerinize ilişkin haklarınızın neler olduğu hususunda sizleri aydınlatmayı amaçlıyoruz.
...
Yukarıda sayılan haklarınızı kullanmak üzere email@email üzerinden bizimle iletişime geçebilirsiniz.

İletişim
Sizlere hizmet sunabilmek amaçlı analizler yapabilmek için, sadece gerekli olan kişisel verilerinizin, işbu gizlilik ve kişisel verilerin işlenmesi politikası uyarınca işlenmesini, kabul edip etmemek hususunda tamamen özgürsünüz. Siteyi kullanmaya devam ettiğiniz takdirde kabul etmiş olduğunuz tarafımızca varsayılacak olup, daha ayrıntılı bilgi için bizimle email@email e-mail adresi üzerinden iletişime geçmekten lütfen çekinmeyiniz.
""";

String blogGizlilikPolitikasiHTML = """
<h1>Gizlilik Politikası</h1>
<p>Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}</p>
<p>
Güvenliğiniz bizim için önemli. Bu sebeple bizimle paylaşacağınız kişisel verileriz hassasiyetle korunmaktadır.
</p>
<p>
Biz, şirketadı, veri sorumlusu olarak, bu gizlilik ve kişisel verilerin korunması politikası ile,
...
<p>Yukarıda sayılan haklarınızı kullanmak üzere email@email üzerinden bizimle iletişime geçebilirsiniz.</p>
<h2>İletişim</h2>
<p>
...
varsayılacak olup, daha ayrıntılı bilgi için bizimle email@email e-mail adresi üzerinden iletişime
geçmekten lütfen çekinmeyiniz.
</p>

""";

String blogGizlilikPolitikasiMarkdown = """
# Gizlilik Politikası
...
şirketadı olarak, sunacağımız hizmetlerin kapsamını ve niteliğini, yasalar çerçevesinde belirlemekte tamamen serbest olup; hizmetlere ilişkin yapacağımız değişiklikler, SİTE'de yayınlanmakla yürürlüğe girmiş sayılacaktır.

Telif Hakları

SİTE'de yayınlanan tüm metin, kod, grafikler, logolar, resimler, ses dosyaları ve kullanılan yazılımın sahibi (bundan böyle ve daha sonra "içerik" olarak anılacaktır) şirketadı olup, tüm hakları saklıdır. Yazılı izin olmaksızın site içeriğinin çoğaltılması veya kopyalanması kesinlikle yasaktır.
...
Uyuşmazlık Çözümü: İşbu Sözleşme'nin uygulanmasından veya yorumlanmasından doğacak her türlü uyuşmazlığın çözümünde, Türkiye Cumhuriyeti yasaları uygulanır; sehir Adliyesi Mahkemeleri ve İcra Daireleri yetkilidir.


""";

String blogKullanimKosullariHTML = """
<h1>Kullanım Koşulları</h1>
<p>Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}</p>
<p>
Sevgili ziyaretçimiz, lütfen webadresi web sitemizi ziyaret etmeden önce işbu
...
<p>
webadresi web sitesi şirketadı tarafından yönetilmekte olup, bundan sonra SİTE olarak anılacaktır.
...
<p>
şirketadı olarak, sunacağımız hizmetlerin kapsamını ve niteliğini, yasalar
...
(bundan böyle ve daha sonra "içerik" olarak anılacaktır) şirketadı olup,
...
sehir Adliyesi Mahkemeleri ve İcra Daireleri yetkilidir.
</p>

""";

String blogKullanimKosullariMarkdown = """
# Kullanım Koşulları
...
- Kullanıcıların tamamı, SİTE'yi yalnızca hukuka uygun ve şahsi amaçlarla kullanacaklarını ve üçüncü kişinin haklarına tecavüz teşkil edecek nitelikteki herhangi bir faaliyette bulunmayacaklarını taahhüt eder. SİTE dâhilinde yaptıkları işlem ve eylemlerindeki, hukuki ve cezai sorumlulukları kendilerine aittir. İşbu iş ve eylemler sebebiyle, üçüncü kişilerin uğradıkları veya uğrayabilecekleri zararlardan dolayı SİTE'nin doğrudan ve/veya dolaylı hiçbir sorumluluğu yoktur.
- SİTE'de mevcut bilgilerin doğruluk ve güncelliğini sağlamak için elimizden geleni yapmaktayız. Lakin gösterdiğimiz çabaya rağmen, bu bilgiler, fiili değişikliklerin gerisinde kalabilir, birtakım farklılıklar olabilir. Bu sebeple, site içerisinde yer alan bilgilerin doğruluğu ve güncelliği ile ilgili tarafımızca, açık veya zımni, herhangi bir garanti verilmemekte, hiçbir taahhütte bulunulmamaktadır.
- SİTE'de üçüncü şahıslar tarafından işletilen ve içerikleri tarafımızca bilinmeyen diğer web sitelerine, uygulamalara ve platformlara köprüler (hyperlink) bulunabilir. SİTE, işlevsellik yalnızca bu sitelere ulaşımı sağlamakta olup, içerikleri ile ilgili hiçbir sorumluluk kabul etmemekteyiz.
- SİTE'yi virüslerden temizlenmiş tutmak konusunda elimizden geleni yapsak da, virüslerin tamamen bulunmadığı garantisini vermemekteyiz. Bu nedenle veri indirirken, virüslere karşı gerekli önlemi almak, kullanıcıların sorumluluğundadır. Virüs vb. kötü amaçlı programlar, kodlar veya materyallerin sebep olabileceği zararlardan dolayı sorumluluk kabul etmemekteyiz.
- SİTE'de sunulan hizmetlerde, kusur veya hata olmayacağına ya da kesintisiz hizmet verileceğine dair garanti vermemekteyiz. SİTE'ye ve sitenin hizmetlerine veya herhangi bir bölümüne olan erişiminizi önceden bildirmeksizin herhangi bir zamanda sonlandırabiliriz.
...
""";
String blogCerezKullanimiDuzmetin = """
Çerez Politikası

Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}

Biz, şirketadı, olarak güvenliğinize önem veriyor ve bu Çerez Politikası ile siz sevgili ziyaretçilerimizi, web sitemizde hangi çerezleri, hangi amaçla kullandığımız ve çerez ayarlarınızı nasıl değiştireceğiniz konularında kısaca bilgilendirmeyi hedefliyoruz.
...
Tüm bu açıklamalardan sonra, hangi çerezlerin kullanılacağı konusu, tamamen kullanıcılarımızın özgür iradelerine bırakılmıştır. Çerez tercihlerinizi, tarayıcınızın ayarlarından silerek ya da engelleyerek, web sitemize adım attığınız anda yönetebilir ya da gelecekte, istediğiniz zaman bu ayarları değiştirebilirsiniz. Daha ayrıntılı bilgi için Gizlilik Politikamıza göz atabilir ya da bizlerle email@email e-mail adresi üzerinden iletişime geçebilirsiniz.


""";

String blogCerezKullanimiHTML = """
<h1>Çerez Politikası</h1>
<p>Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}</p>
<p>
Biz, şirketadı, olarak güvenliğinize önem veriyor ve bu Çerez Politikası ile siz
...
göz atabilir ya da bizlerle email@email e-mail adresi üzerinden iletişime geçebilirsiniz.
</p>


""";

String blogCerezKullanimiMarkdown = """
# Çerez Politikası
...
Tüm bu açıklamalardan sonra, hangi çerezlerin kullanılacağı konusu, tamamen kullanıcılarımızın özgür iradelerine bırakılmıştır. Çerez tercihlerinizi, tarayıcınızın ayarlarından silerek ya da engelleyerek, web sitemize adım attığınız anda yönetebilir ya da gelecekte, istediğiniz zaman bu ayarları değiştirebilirsiniz. Daha ayrıntılı bilgi için Gizlilik Politikamıza göz atabilir ya da bizlerle [email@email](mailto:email@email) e-mail adresi üzerinden iletişime geçebilirsiniz.



""";

String eticaretGizlilikPolitikasiDuzmetin = """
Gizlilik Politikası
...
String eticaretGizlilikPolitikasiHTML = """
<h1>Gizlilik Politikası</h1>
<p>Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}</p>
<p>
Güvenliğiniz bizim için önemli. Bu sebeple bizimle paylaşacağınız kişisel verileriz hassasiyetle korunmaktadır.
...
için bizimle email@email e-mail adresi üzerinden iletişime geçmekten lütfen çekinmeyiniz.
</p>

""";

String eticaretGizlilikPolitikasiMarkdown = """
# Gizlilik Politikası
...
""";
String eticaretKullanimKosullariDuzmetin = """
Kullanım Koşulları
...
String eticaretKullanimKosullariHTML = """
<h1>Kullanım Koşulları</h1>
<p>Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}</p>
<p>
Sevgili ziyaretçimiz, lütfen webadresi web sitemizi ziyaret etmeden önce işbu
...
String eticaretKullanimKosullariMarkdown = """
# Kullanım Koşulları
...
""";
String eticaretCerezKullanimiDuzmetin = """
Çerez Politikası
...
String eticaretCerezKullanimiHTML = """
<h1>Çerez Politikası</h1>
<p>Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}</p>
<p>
Biz, şirketadı, olarak güvenliğinize önem veriyor ve bu Çerez Politikası ile siz
...
String eticaretCerezKullanimiMarkdown = """
# Çerez Politikası
...
String mobilUygulamaGizlilikPolitikasiDuzmetin = """
Gizlilik Politikası
...
String mobilUygulamaGizlilikPolitikasiMarkdown = """
# Gizlilik Politikası
...
Yukarıda sayılan haklarınızı kullanmak üzere [email@email](mailto:email@email) üzerinden bizimle iletişime geçebilirsiniz.

## İletişim

Sizlere talepleriniz doğrultusunda hizmet sunabilmek amacıyla, sadece gerekli olan kişisel verilerinizin, işbu gizlilik ve kişisel verilerin işlenmesi politikası uyarınca işlenmesini, kabul edip etmemek hususunda tamamen özgürsünüz. Uygulamayı kullanmaya devam ettiğiniz takdirde, kabul etmiş olduğunuz tarafımızca varsayılacaktır. Şayet kabul etmiyorsanız, lütfen uygulamayı tüm cihazlarınızdan kaldırınız. Ayrıntılı bilgi için bizimle [email@email](mailto:email@email) e-mail adresi üzerinden iletişime geçmekten lütfen çekinmeyiniz.



""";
String mobilUygulamaKullanimKosullariDuzmetin = """
Kullanım Koşulları
...
String mobilUygulamaKullanimKosullariHTML = """
<h1>Kullanım Koşulları</h1>
<p>Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}</p>
<p>
Sevgili ziyaretçimiz, lütfen webadresi web sitemizi ziyaret etmeden önce işbu
...
String mobilUygulamaKullanimKosullariMarkdown = """
# Kullanım Koşulları
...
""";
String mobilUygulamaCerezKullanimiDuzmetin = """
Çerez Politikası
...
String mobilUygulamaCerezKullanimiHTML = """
<h1>Çerez Politikası</h1>
<p>Son güncellenme: ${CosmosTime.day()}/${CosmosTime.month()}/${CosmosTime.year()}</p>
<p>
Biz, şirketadı, olarak güvenliğinize önem veriyor ve bu Çerez Politikası ile siz
...
String mobilUygulamaCerezKullanimiMarkdown = """
# Çerez Politikası
